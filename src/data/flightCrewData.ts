...
export const INITIAL_FLIGHT_CREW: CrewMember[] = [
  {
    ...
    avatarUrl: '/crew/crew-kidanu.png.jpg',
    callsign: 'COSMOS-1',
  ...
  },
  {
    ...
    avatarUrl: '/crew/crew-alazar.png.jpg',
    callsign: 'POWER-2',
  ...
  },
  {
    ...
    avatarUrl: '/crew/crew-eyob.png.jpg',
    callsign: 'DEORBIT-3',
  ...
  },
  {
    ...
    avatarUrl: '/crew/crewbereket-kassaye-oda.jpg.jpg',
    callsign: 'ADVISOR-4',
    bio: 'Aerospace engineer who advised the pioneering cohort during the capstone internship, supporting mission systems thinking and professional development.',
  },
];
